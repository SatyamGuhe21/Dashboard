    ...
    <main className="main-container">
      ...
      <div style={{ display: "flex", marginBottom: "20px" }}>
        ...
        <button
          style={{
            ...
            borderRadius: "20px",
            border: "none",
            backgroundColor: activeTab === "restaurant" ? "#c8b7a6" : "#e0e0e0",
            cursor: "pointer",
            fontWeight: "bold",
          }}
      ...
      <div className="chart-card" style={{ marginBottom: "20px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "center" }}>
          <div>
            <label htmlFor="itemName" style={{ display: "block", marginBottom: "8px" }}>
              Item Name:
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="unitPrice" style={{ display: "block", marginBottom: "8px" }}>
              Unit Price: $
            </label>
            <input
              type="number"
      ...
      <div className="chart-card">
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          ...
          <button
            ...
            onClick={() => generateReport("Custom Date")}
          >
            [Custom Date]
          </button>
          <button

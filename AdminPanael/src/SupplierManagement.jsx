    ...
    <main className="main-container">
      ...
      <div className="chart-card" style={{ marginBottom: "20px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "center" }}>
          <div>
            <label htmlFor="supplierName" style={{ display: "block", marginBottom: "8px" }}>
              Supplier Name:
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="contactPerson" style={{ display: "block", marginBottom: "8px" }}>
              Contact Person:
            </label>
            <input
              type="text"
      ...
      <div className="chart-card">
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          ...
          <button
            ...
            onClick={() => generateReport("Active Suppliers")}
          >
            [Active Suppliers]
          </button>
          <button
            ...
            onClick={() => generateReport("Inactive Suppliers")}
          >
            [Inactive Suppliers]
          </button>
          <button

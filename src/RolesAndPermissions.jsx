    ...
    <main className="main-container">
      ...
      <div className="chart-card" style={{ marginBottom: "20px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "center" }}>
          <div>
            <label htmlFor="roleName" style={{ display: "block", marginBottom: "8px" }}>Role Name:</label>
            <input
              type="text"
              id="roleName"
              value={newRoleName}
          ...
          <div>
            <label htmlFor="permissions" style={{ display: "block", marginBottom: "8px" }}>Permissions:</label>
            <input
              type="text"
              id="permissions"
      ...
      <div className="chart-card">
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "16px" }}>
          <div>
            <label htmlFor="selectRole" style={{ display: "block", marginBottom: "8px" }}>Select Role:</label>
            <select
              id="selectRole"
              style={{ padding: "8px", border: "1px solid #ccc", borderRadius: "4px" }}
              value={selectedRole}

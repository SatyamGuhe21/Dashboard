    ...
    <main className="main-container">
      ...
      <div className="chart-card" style={{ marginBottom: "20px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "center" }}>
          <div>
            <label htmlFor="customerName" style={{ display: "block", marginBottom: "8px" }}>Customer Name:</label>
            <input
              type="text"
              id="customerName"
              value={newCustomer}
          ...
          <div>
            <label htmlFor="items" style={{ display: "block", marginBottom: "8px" }}>Item(s):</label>
            <input
              type="text"
              id="items"
              value={newItems}
          ...
          <div>
            <label htmlFor="totalPrice" style={{ display: "block", marginBottom: "8px" }}>Total Price: $</label>
            <input
              type="number"
              id="totalPrice"
              value={newTotalPrice}
